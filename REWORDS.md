...
**539 are altered** and 3,550 are left as Team Cherry wrote them.

A further **25 rules match text the mod cannot reach** — see section 4.
...
| `Through dream I travel` | `From land to land I travel` |
| `the flame in dream` | `the scarlet flame` |
| `In dreams... Born anew` | `The flame endures... The child rises` |
...
| `The expanse of dream in past was split,<br>One realm now must stay apart,` | `The Troupe's own heart in past was split,<br>One half now must stay apart,` |
...
|---|---|---:|
| `Achievements` | Steam achievement data, not the game's language files | 25 |
...
- **539** entries changed, 3,550 untouched
- **25** further rules match unreachable text (section 4)
